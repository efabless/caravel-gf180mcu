...
#place_io_ol
set ::env(SAVE_DEF) [index_file $::env(floorplan_tmpfiles)/gpio_control_block_mgmt.io.def]
...
set powered_netlist_name [index_file $::env(signoff_results)/powered_netlist.v]
set powered_def_name [index_file $::env(signoff_results)/powered_def.def]
...
save_views -save_path $save_path \
        ...
        -lef_path $::env(signoff_results)/$::env(DESIGN_NAME).lef \
