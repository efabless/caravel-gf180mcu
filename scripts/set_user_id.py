...
# Vias are not on the route pitch.  Layout is in two rows, with Y = 4.335
# on the lower row and Y = 9.385 on the upper row.  Bits alternate between
# the lower and upper rows.
#
# Signal        Via position (um)
# name		X      Y     
#--------------------------------
# mask_rev[0]    9.21  9.385
# mask_rev[1]	 9.21  4.335
# mask_rev[2]	15.93  9.385
# mask_rev[3]	15.93  4.335
# mask_rev[4]	21.53  9.385
# mask_rev[5]	21.53  4.335
# mask_rev[6]	28.25  9.385
# mask_rev[7]   28.25  4.335
# mask_rev[8]   33.85  9.385
# mask_rev[9]   33.85  4.335
# mask_rev[10]  40.57  9.385
# mask_rev[11]  40.57  4.335
# mask_rev[12]	46.17  9.385
# mask_rev[13]	46.17  4.335
# mask_rev[14]	52.89  9.385
# mask_rev[15]	52.89  4.335
# mask_rev[16]	58.49  9.385
# mask_rev[17]	58.49  4.335
# mask_rev[18]	65.21  9.385
# mask_rev[19]	65.21  4.335
# mask_rev[20]	70.81  9.385
# mask_rev[21]	70.81  4.335
# mask_rev[22]	77.53  9.385
# mask_rev[23]	77.53  4.335
# mask_rev[24]	83.13  9.385
# mask_rev[25]	83.13  4.335
# mask_rev[26]	89.85  9.385
# mask_rev[27]	89.85  4.335
# mask_rev[28]	95.45  9.385
# mask_rev[29]	95.45  4.335
# mask_rev[30] 102.17  9.385
# mask_rev[31] 102.17  4.335
#----------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    mask_rev = (
	(9.21,  9.385), (9.21,  4.335), (15.93,  9.385), (15.93,  4.335),
	(21.53, 9.385), (21.53, 4.335), (28.25,  9.385), (28.25,  4.335),
	(33.85, 9.385), (33.85, 4.335), (40.57,  9.385), (40.57,  4.335),
	(46.17, 9.385), (46.17, 4.335), (52.89,  9.385), (52.89,  4.335),
	(58.49, 9.385), (58.49, 4.335), (65.21,  9.385), (65.21,  4.335),
	(70.81, 9.385), (70.81, 4.335), (77.53,  9.385), (77.53,  4.335),
	(83.13, 9.385), (83.13, 4.335), (89.85,  9.385), (89.85,  4.335),
	(95.45, 9.385), (95.45, 4.335), (102.17, 9.385), (102.17, 4.335));
