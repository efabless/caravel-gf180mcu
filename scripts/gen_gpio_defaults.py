...
# user_defines.v file.
#
# The GPIO defaults block contains 10 bits that set the state of the
...
# the via 1.59um to the left.  The given position is the lower left
# corner position of the via.  The via itself is 0.3um x 0.3um.
# The values below are for a configuration value of all zeros.
#
...
if __name__ == '__main__':
    ...
    kvpairs["`USER_CONFIG_GPIO_0_INIT"] = "10'h009"
    kvpairs["`USER_CONFIG_GPIO_1_INIT"] = "10'h009"
    kvpairs["`USER_CONFIG_GPIO_2_INIT"] = "10'h007"
    kvpairs["`USER_CONFIG_GPIO_3_INIT"] = "10'h087"
    kvpairs["`USER_CONFIG_GPIO_4_INIT"] = "10'h007"
    ...
    for i in range(0, 10):
        centx = round(via_pos[i][0] * 200)
        centy = round(via_pos[i][1] * 200)
        llx_zero = centx - 30
        lly_zero = centy - 30
        urx_zero = centx + 30
        ury_zero = centy + 30

        llx_one = llx_zero - 318
        lly_one = lly_zero
        urx_one = urx_zero - 318
        ury_one = ury_zero
