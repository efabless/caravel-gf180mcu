if {\
  [catch {
    ...
    if {$::env(DESIGN) == "mgmt_core_wrapper" | $::env(DESIGN) == "RAM256" | $::env(DESIGN) == "RAM128" | $::env(DESIGN) == "gf180_ram_512x8_wrapper"} {
    ...
    proc read_spefs {design rc_corner} {
      ...
      if {$design == "mgmt_core_wrapper" | $design == "RAM128" | $design == "RAM256" | $design == "gf180_ram_512x8_wrapper"} {
        ...
        read_parasitics -keep_capacitive_coupling -verbose $::env(MCW_ROOT)/signoff/${design}/StarRC/${design}.${rc_corner}.spef -pin_cap_included -complete_with wlm
      } else {
