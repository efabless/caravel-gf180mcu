...
# IO 4 mode is either SCK or GPIO
set io_4_mode SCK
## MASTER CLOCKS
...
if {$io_4_mode == "GPIO"} {
   ...
   set_input_delay $output_delay_value  -clock [get_clocks {clk}] -add_delay [get_ports {mprj_io[1]}]
   ...
   set_false_path -from [get_ports mprj_io[4]] -through [get_pins chip_core/housekeeping/mgmt_gpio_in[4]]
