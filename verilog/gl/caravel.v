...
module caravel(vdd, vss, gpio, mprj_io, clock, resetb, flash_csb, flash_clk, flash_io0, flash_io1);
  wire caravel_clk;
  wire caravel_clk2;
  wire caravel_rstn;
  input clock;
  ...
  gpio_control_block \gpio_control_bidir_1[0]  (
    ...
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[1] , \mprj_io_drive_sel[0]  }),
    .pad_gpio_in(\mprj_io_in[0] ),
    .pad_gpio_inen(\mprj_io_ie[0] ),
    .pad_gpio_out(\mprj_io_out[0] ),
    .pad_gpio_outen(\mprj_io_oe[0] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[0] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[0] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[0] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[0] ),
  ...
  gpio_control_block \gpio_control_bidir_1[1]  (
    ...
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[3] , \mprj_io_drive_sel[2]  }),
    .pad_gpio_in(\mprj_io_in[1] ),
    .pad_gpio_inen(\mprj_io_ie[1] ),
    .pad_gpio_out(\mprj_io_out[1] ),
    .pad_gpio_outen(\mprj_io_oe[1] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[1] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[1] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[1] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[1] ),
  ...
  gpio_control_block \gpio_control_bidir_2[0]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[359] , \gpio_defaults[358] , \gpio_defaults[357] , \gpio_defaults[356] , \gpio_defaults[355] , \gpio_defaults[354] , \gpio_defaults[353] , \gpio_defaults[352] , \gpio_defaults[351] , \gpio_defaults[350]  }),
    .mgmt_gpio_in(\mgmt_io_in[35] ),
    .mgmt_gpio_oeb(\mgmt_io_oeb[2] ),
    .mgmt_gpio_out(\mgmt_io_out[35] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[71] , \mprj_io_drive_sel[70]  }),
    .pad_gpio_in(\mprj_io_in[35] ),
    .pad_gpio_inen(\mprj_io_ie[35] ),
    .pad_gpio_out(\mprj_io_out[35] ),
    .pad_gpio_outen(\mprj_io_oe[35] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[35] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[35] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[35] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[35] ),
  ...
  gpio_control_block \gpio_control_bidir_2[1]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[369] , \gpio_defaults[368] , \gpio_defaults[367] , \gpio_defaults[366] , \gpio_defaults[365] , \gpio_defaults[364] , \gpio_defaults[363] , \gpio_defaults[362] , \gpio_defaults[361] , \gpio_defaults[360]  }),
    .mgmt_gpio_in(\mgmt_io_in[36] ),
    .mgmt_gpio_oeb(\mgmt_io_oeb[3] ),
    .mgmt_gpio_out(\mgmt_io_out[36] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[73] , \mprj_io_drive_sel[72]  }),
    .pad_gpio_in(\mprj_io_in[36] ),
    .pad_gpio_inen(\mprj_io_ie[36] ),
    .pad_gpio_out(\mprj_io_out[36] ),
    .pad_gpio_outen(\mprj_io_oe[36] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[36] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[36] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[36] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[36] ),
  ...
  gpio_control_block \gpio_control_bidir_2[2]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[379] , \gpio_defaults[378] , \gpio_defaults[377] , \gpio_defaults[376] , \gpio_defaults[375] , \gpio_defaults[374] , \gpio_defaults[373] , \gpio_defaults[372] , \gpio_defaults[371] , \gpio_defaults[370]  }),
    .mgmt_gpio_in(\mgmt_io_in[37] ),
    .mgmt_gpio_oeb(\mgmt_io_oeb[4] ),
    .mgmt_gpio_out(\mgmt_io_out[37] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[75] , \mprj_io_drive_sel[74]  }),
    .pad_gpio_in(\mprj_io_in[37] ),
    .pad_gpio_inen(\mprj_io_ie[37] ),
    .pad_gpio_out(\mprj_io_out[37] ),
    .pad_gpio_outen(\mprj_io_oe[37] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[37] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[37] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[37] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[37] ),
    .resetn(\gpio_resetn_1_shifted[0] ),
  ...
  gpio_control_block \gpio_control_in_1[0]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[89] , \gpio_defaults[88] , \gpio_defaults[87] , \gpio_defaults[86] , \gpio_defaults[85] , \gpio_defaults[84] , \gpio_defaults[83] , \gpio_defaults[82] , \gpio_defaults[81] , \gpio_defaults[80]  }),
    .mgmt_gpio_in(\mgmt_io_in[8] ),
    .mgmt_gpio_oeb(\zero_loop1[8] ),
    .mgmt_gpio_out(\mgmt_io_out[8] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[17] , \mprj_io_drive_sel[16]  }),
    .pad_gpio_in(\mprj_io_in[8] ),
    .pad_gpio_inen(\mprj_io_ie[8] ),
    .pad_gpio_out(\mprj_io_out[8] ),
    .pad_gpio_outen(\mprj_io_oe[8] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[8] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[8] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[8] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[8] ),
  ...
  gpio_control_block \gpio_control_in_1[10]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[189] , \gpio_defaults[188] , \gpio_defaults[187] , \gpio_defaults[186] , \gpio_defaults[185] , \gpio_defaults[184] , \gpio_defaults[183] , \gpio_defaults[182] , \gpio_defaults[181] , \gpio_defaults[180]  }),
    .mgmt_gpio_in(\mgmt_io_in[18] ),
    .mgmt_gpio_oeb(\zero_loop1[18] ),
    .mgmt_gpio_out(\mgmt_io_out[18] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[37] , \mprj_io_drive_sel[36]  }),
    .pad_gpio_in(\mprj_io_in[18] ),
    .pad_gpio_inen(\mprj_io_ie[18] ),
    .pad_gpio_out(\mprj_io_out[18] ),
    .pad_gpio_outen(\mprj_io_oe[18] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[18] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[18] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[18] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[18] ),
  ...
  gpio_control_block \gpio_control_in_1[1]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[99] , \gpio_defaults[98] , \gpio_defaults[97] , \gpio_defaults[96] , \gpio_defaults[95] , \gpio_defaults[94] , \gpio_defaults[93] , \gpio_defaults[92] , \gpio_defaults[91] , \gpio_defaults[90]  }),
    .mgmt_gpio_in(\mgmt_io_in[9] ),
    .mgmt_gpio_oeb(\zero_loop1[9] ),
    .mgmt_gpio_out(\mgmt_io_out[9] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[19] , \mprj_io_drive_sel[18]  }),
    .pad_gpio_in(\mprj_io_in[9] ),
    .pad_gpio_inen(\mprj_io_ie[9] ),
    .pad_gpio_out(\mprj_io_out[9] ),
    .pad_gpio_outen(\mprj_io_oe[9] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[9] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[9] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[9] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[9] ),
  ...
  gpio_control_block \gpio_control_in_1[2]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[109] , \gpio_defaults[108] , \gpio_defaults[107] , \gpio_defaults[106] , \gpio_defaults[105] , \gpio_defaults[104] , \gpio_defaults[103] , \gpio_defaults[102] , \gpio_defaults[101] , \gpio_defaults[100]  }),
    .mgmt_gpio_in(\mgmt_io_in[10] ),
    .mgmt_gpio_oeb(\zero_loop1[10] ),
    .mgmt_gpio_out(\mgmt_io_out[10] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[21] , \mprj_io_drive_sel[20]  }),
    .pad_gpio_in(\mprj_io_in[10] ),
    .pad_gpio_inen(\mprj_io_ie[10] ),
    .pad_gpio_out(\mprj_io_out[10] ),
    .pad_gpio_outen(\mprj_io_oe[10] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[10] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[10] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[10] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[10] ),
  ...
  gpio_control_block \gpio_control_in_1[3]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[119] , \gpio_defaults[118] , \gpio_defaults[117] , \gpio_defaults[116] , \gpio_defaults[115] , \gpio_defaults[114] , \gpio_defaults[113] , \gpio_defaults[112] , \gpio_defaults[111] , \gpio_defaults[110]  }),
    .mgmt_gpio_in(\mgmt_io_in[11] ),
    .mgmt_gpio_oeb(\zero_loop1[11] ),
    .mgmt_gpio_out(\mgmt_io_out[11] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[23] , \mprj_io_drive_sel[22]  }),
    .pad_gpio_in(\mprj_io_in[11] ),
    .pad_gpio_inen(\mprj_io_ie[11] ),
    .pad_gpio_out(\mprj_io_out[11] ),
    .pad_gpio_outen(\mprj_io_oe[11] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[11] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[11] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[11] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[11] ),
  ...
  gpio_control_block \gpio_control_in_1[4]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[129] , \gpio_defaults[128] , \gpio_defaults[127] , \gpio_defaults[126] , \gpio_defaults[125] , \gpio_defaults[124] , \gpio_defaults[123] , \gpio_defaults[122] , \gpio_defaults[121] , \gpio_defaults[120]  }),
    .mgmt_gpio_in(\mgmt_io_in[12] ),
    .mgmt_gpio_oeb(\zero_loop1[12] ),
    .mgmt_gpio_out(\mgmt_io_out[12] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[25] , \mprj_io_drive_sel[24]  }),
    .pad_gpio_in(\mprj_io_in[12] ),
    .pad_gpio_inen(\mprj_io_ie[12] ),
    .pad_gpio_out(\mprj_io_out[12] ),
    .pad_gpio_outen(\mprj_io_oe[12] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[12] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[12] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[12] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[12] ),
  ...
  gpio_control_block \gpio_control_in_1[5]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[139] , \gpio_defaults[138] , \gpio_defaults[137] , \gpio_defaults[136] , \gpio_defaults[135] , \gpio_defaults[134] , \gpio_defaults[133] , \gpio_defaults[132] , \gpio_defaults[131] , \gpio_defaults[130]  }),
    .mgmt_gpio_in(\mgmt_io_in[13] ),
    .mgmt_gpio_oeb(\zero_loop1[13] ),
    .mgmt_gpio_out(\mgmt_io_out[13] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[27] , \mprj_io_drive_sel[26]  }),
    .pad_gpio_in(\mprj_io_in[13] ),
    .pad_gpio_inen(\mprj_io_ie[13] ),
    .pad_gpio_out(\mprj_io_out[13] ),
    .pad_gpio_outen(\mprj_io_oe[13] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[13] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[13] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[13] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[13] ),
  ...
  gpio_control_block \gpio_control_in_1[6]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[149] , \gpio_defaults[148] , \gpio_defaults[147] , \gpio_defaults[146] , \gpio_defaults[145] , \gpio_defaults[144] , \gpio_defaults[143] , \gpio_defaults[142] , \gpio_defaults[141] , \gpio_defaults[140]  }),
    .mgmt_gpio_in(\mgmt_io_in[14] ),
    .mgmt_gpio_oeb(\zero_loop1[14] ),
    .mgmt_gpio_out(\mgmt_io_out[14] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[29] , \mprj_io_drive_sel[28]  }),
    .pad_gpio_in(\mprj_io_in[14] ),
    .pad_gpio_inen(\mprj_io_ie[14] ),
    .pad_gpio_out(\mprj_io_out[14] ),
    .pad_gpio_outen(\mprj_io_oe[14] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[14] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[14] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[14] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[14] ),
  ...
  gpio_control_block \gpio_control_in_1[7]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[159] , \gpio_defaults[158] , \gpio_defaults[157] , \gpio_defaults[156] , \gpio_defaults[155] , \gpio_defaults[154] , \gpio_defaults[153] , \gpio_defaults[152] , \gpio_defaults[151] , \gpio_defaults[150]  }),
    .mgmt_gpio_in(\mgmt_io_in[15] ),
    .mgmt_gpio_oeb(\zero_loop1[15] ),
    .mgmt_gpio_out(\mgmt_io_out[15] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[31] , \mprj_io_drive_sel[30]  }),
    .pad_gpio_in(\mprj_io_in[15] ),
    .pad_gpio_inen(\mprj_io_ie[15] ),
    .pad_gpio_out(\mprj_io_out[15] ),
    .pad_gpio_outen(\mprj_io_oe[15] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[15] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[15] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[15] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[15] ),
  ...
  gpio_control_block \gpio_control_in_1[8]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[169] , \gpio_defaults[168] , \gpio_defaults[167] , \gpio_defaults[166] , \gpio_defaults[165] , \gpio_defaults[164] , \gpio_defaults[163] , \gpio_defaults[162] , \gpio_defaults[161] , \gpio_defaults[160]  }),
    .mgmt_gpio_in(\mgmt_io_in[16] ),
    .mgmt_gpio_oeb(\zero_loop1[16] ),
    .mgmt_gpio_out(\mgmt_io_out[16] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[33] , \mprj_io_drive_sel[32]  }),
    .pad_gpio_in(\mprj_io_in[16] ),
    .pad_gpio_inen(\mprj_io_ie[16] ),
    .pad_gpio_out(\mprj_io_out[16] ),
    .pad_gpio_outen(\mprj_io_oe[16] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[16] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[16] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[16] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[16] ),
  ...
  gpio_control_block \gpio_control_in_1[9]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[179] , \gpio_defaults[178] , \gpio_defaults[177] , \gpio_defaults[176] , \gpio_defaults[175] , \gpio_defaults[174] , \gpio_defaults[173] , \gpio_defaults[172] , \gpio_defaults[171] , \gpio_defaults[170]  }),
    .mgmt_gpio_in(\mgmt_io_in[17] ),
    .mgmt_gpio_oeb(\zero_loop1[17] ),
    .mgmt_gpio_out(\mgmt_io_out[17] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[35] , \mprj_io_drive_sel[34]  }),
    .pad_gpio_in(\mprj_io_in[17] ),
    .pad_gpio_inen(\mprj_io_ie[17] ),
    .pad_gpio_out(\mprj_io_out[17] ),
    .pad_gpio_outen(\mprj_io_oe[17] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[17] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[17] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[17] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[17] ),
  ...
  gpio_control_block \gpio_control_in_1a[0]  (
    ...
    .mgmt_gpio_oeb(\zero_loop1[2] ),
    .mgmt_gpio_out(\mgmt_io_out[2] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[5] , \mprj_io_drive_sel[4]  }),
    .pad_gpio_in(\mprj_io_in[2] ),
    .pad_gpio_inen(\mprj_io_ie[2] ),
    .pad_gpio_out(\mprj_io_out[2] ),
    .pad_gpio_outen(\mprj_io_oe[2] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[2] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[2] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[2] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[2] ),
  ...
  gpio_control_block \gpio_control_in_1a[1]  (
    ...
    .mgmt_gpio_oeb(\zero_loop1[3] ),
    .mgmt_gpio_out(\mgmt_io_out[3] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[7] , \mprj_io_drive_sel[6]  }),
    .pad_gpio_in(\mprj_io_in[3] ),
    .pad_gpio_inen(\mprj_io_ie[3] ),
    .pad_gpio_out(\mprj_io_out[3] ),
    .pad_gpio_outen(\mprj_io_oe[3] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[3] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[3] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[3] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[3] ),
  ...
  gpio_control_block \gpio_control_in_1a[2]  (
    ...
    .mgmt_gpio_oeb(\zero_loop1[4] ),
    .mgmt_gpio_out(\mgmt_io_out[4] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[9] , \mprj_io_drive_sel[8]  }),
    .pad_gpio_in(\mprj_io_in[4] ),
    .pad_gpio_inen(\mprj_io_ie[4] ),
    .pad_gpio_out(\mprj_io_out[4] ),
    .pad_gpio_outen(\mprj_io_oe[4] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[4] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[4] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[4] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[4] ),
  ...
  gpio_control_block \gpio_control_in_1a[3]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[59] , \gpio_defaults[58] , \gpio_defaults[57] , \gpio_defaults[56] , \gpio_defaults[55] , \gpio_defaults[54] , \gpio_defaults[53] , \gpio_defaults[52] , \gpio_defaults[51] , \gpio_defaults[50]  }),
    .mgmt_gpio_in(\mgmt_io_in[5] ),
    .mgmt_gpio_oeb(\zero_loop1[5] ),
    .mgmt_gpio_out(\mgmt_io_out[5] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[11] , \mprj_io_drive_sel[10]  }),
    .pad_gpio_in(\mprj_io_in[5] ),
    .pad_gpio_inen(\mprj_io_ie[5] ),
    .pad_gpio_out(\mprj_io_out[5] ),
    .pad_gpio_outen(\mprj_io_oe[5] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[5] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[5] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[5] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[5] ),
  ...
  gpio_control_block \gpio_control_in_1a[4]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[69] , \gpio_defaults[68] , \gpio_defaults[67] , \gpio_defaults[66] , \gpio_defaults[65] , \gpio_defaults[64] , \gpio_defaults[63] , \gpio_defaults[62] , \gpio_defaults[61] , \gpio_defaults[60]  }),
    .mgmt_gpio_in(\mgmt_io_in[6] ),
    .mgmt_gpio_oeb(\zero_loop1[6] ),
    .mgmt_gpio_out(\mgmt_io_out[6] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[13] , \mprj_io_drive_sel[12]  }),
    .pad_gpio_in(\mprj_io_in[6] ),
    .pad_gpio_inen(\mprj_io_ie[6] ),
    .pad_gpio_out(\mprj_io_out[6] ),
    .pad_gpio_outen(\mprj_io_oe[6] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[6] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[6] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[6] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[6] ),
  ...
  gpio_control_block \gpio_control_in_1a[5]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[79] , \gpio_defaults[78] , \gpio_defaults[77] , \gpio_defaults[76] , \gpio_defaults[75] , \gpio_defaults[74] , \gpio_defaults[73] , \gpio_defaults[72] , \gpio_defaults[71] , \gpio_defaults[70]  }),
    .mgmt_gpio_in(\mgmt_io_in[7] ),
    .mgmt_gpio_oeb(\zero_loop1[7] ),
    .mgmt_gpio_out(\mgmt_io_out[7] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[15] , \mprj_io_drive_sel[14]  }),
    .pad_gpio_in(\mprj_io_in[7] ),
    .pad_gpio_inen(\mprj_io_ie[7] ),
    .pad_gpio_out(\mprj_io_out[7] ),
    .pad_gpio_outen(\mprj_io_oe[7] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[7] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[7] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[7] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[7] ),
  ...
  gpio_control_block \gpio_control_in_2[0]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[199] , \gpio_defaults[198] , \gpio_defaults[197] , \gpio_defaults[196] , \gpio_defaults[195] , \gpio_defaults[194] , \gpio_defaults[193] , \gpio_defaults[192] , \gpio_defaults[191] , \gpio_defaults[190]  }),
    .mgmt_gpio_in(\mgmt_io_in[19] ),
    .mgmt_gpio_oeb(\zero_loop2[0] ),
    .mgmt_gpio_out(\mgmt_io_out[19] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[39] , \mprj_io_drive_sel[38]  }),
    .pad_gpio_in(\mprj_io_in[19] ),
    .pad_gpio_inen(\mprj_io_ie[19] ),
    .pad_gpio_out(\mprj_io_out[19] ),
    .pad_gpio_outen(\mprj_io_oe[19] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[19] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[19] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[19] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[19] ),
  ...
  gpio_control_block \gpio_control_in_2[10]  (
    ...
    .mgmt_gpio_oeb(\zero_loop2[10] ),
    .mgmt_gpio_out(\mgmt_io_out[29] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[59] , \mprj_io_drive_sel[58]  }),
    .pad_gpio_in(\mprj_io_in[29] ),
    .pad_gpio_inen(\mprj_io_ie[29] ),
    .pad_gpio_out(\mprj_io_out[29] ),
    .pad_gpio_outen(\mprj_io_oe[29] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[29] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[29] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[29] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[29] ),
  ...
  gpio_control_block \gpio_control_in_2[11]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[309] , \gpio_defaults[308] , \gpio_defaults[307] , \gpio_defaults[306] , \gpio_defaults[305] , \gpio_defaults[304] , \gpio_defaults[303] , \gpio_defaults[302] , \gpio_defaults[301] , \gpio_defaults[300]  }),
    .mgmt_gpio_in(\mgmt_io_in[30] ),
    .mgmt_gpio_oeb(\zero_loop2[11] ),
    .mgmt_gpio_out(\mgmt_io_out[30] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[61] , \mprj_io_drive_sel[60]  }),
    .pad_gpio_in(\mprj_io_in[30] ),
    .pad_gpio_inen(\mprj_io_ie[30] ),
    .pad_gpio_out(\mprj_io_out[30] ),
    .pad_gpio_outen(\mprj_io_oe[30] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[30] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[30] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[30] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[30] ),
  ...
  gpio_control_block \gpio_control_in_2[12]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[319] , \gpio_defaults[318] , \gpio_defaults[317] , \gpio_defaults[316] , \gpio_defaults[315] , \gpio_defaults[314] , \gpio_defaults[313] , \gpio_defaults[312] , \gpio_defaults[311] , \gpio_defaults[310]  }),
    .mgmt_gpio_in(\mgmt_io_in[31] ),
    .mgmt_gpio_oeb(\zero_loop2[12] ),
    .mgmt_gpio_out(\mgmt_io_out[31] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[63] , \mprj_io_drive_sel[62]  }),
    .pad_gpio_in(\mprj_io_in[31] ),
    .pad_gpio_inen(\mprj_io_ie[31] ),
    .pad_gpio_out(\mprj_io_out[31] ),
    .pad_gpio_outen(\mprj_io_oe[31] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[31] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[31] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[31] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[31] ),
  ...
  gpio_control_block \gpio_control_in_2[13]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[329] , \gpio_defaults[328] , \gpio_defaults[327] , \gpio_defaults[326] , \gpio_defaults[325] , \gpio_defaults[324] , \gpio_defaults[323] , \gpio_defaults[322] , \gpio_defaults[321] , \gpio_defaults[320]  }),
    .mgmt_gpio_in(\mgmt_io_in[32] ),
    .mgmt_gpio_oeb(\zero_loop2[13] ),
    .mgmt_gpio_out(\mgmt_io_out[32] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[65] , \mprj_io_drive_sel[64]  }),
    .pad_gpio_in(\mprj_io_in[32] ),
    .pad_gpio_inen(\mprj_io_ie[32] ),
    .pad_gpio_out(\mprj_io_out[32] ),
    .pad_gpio_outen(\mprj_io_oe[32] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[32] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[32] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[32] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[32] ),
  ...
  gpio_control_block \gpio_control_in_2[14]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[339] , \gpio_defaults[338] , \gpio_defaults[337] , \gpio_defaults[336] , \gpio_defaults[335] , \gpio_defaults[334] , \gpio_defaults[333] , \gpio_defaults[332] , \gpio_defaults[331] , \gpio_defaults[330]  }),
    .mgmt_gpio_in(\mgmt_io_in[33] ),
    .mgmt_gpio_oeb(\zero_loop2[14] ),
    .mgmt_gpio_out(\mgmt_io_out[33] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[67] , \mprj_io_drive_sel[66]  }),
    .pad_gpio_in(\mprj_io_in[33] ),
    .pad_gpio_inen(\mprj_io_ie[33] ),
    .pad_gpio_out(\mprj_io_out[33] ),
    .pad_gpio_outen(\mprj_io_oe[33] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[33] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[33] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[33] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[33] ),
  ...
  gpio_control_block \gpio_control_in_2[15]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[349] , \gpio_defaults[348] , \gpio_defaults[347] , \gpio_defaults[346] , \gpio_defaults[345] , \gpio_defaults[344] , \gpio_defaults[343] , \gpio_defaults[342] , \gpio_defaults[341] , \gpio_defaults[340]  }),
    .mgmt_gpio_in(\mgmt_io_in[34] ),
    .mgmt_gpio_oeb(\zero_loop2[15] ),
    .mgmt_gpio_out(\mgmt_io_out[34] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[69] , \mprj_io_drive_sel[68]  }),
    .pad_gpio_in(\mprj_io_in[34] ),
    .pad_gpio_inen(\mprj_io_ie[34] ),
    .pad_gpio_out(\mprj_io_out[34] ),
    .pad_gpio_outen(\mprj_io_oe[34] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[34] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[34] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[34] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[34] ),
  ...
  gpio_control_block \gpio_control_in_2[1]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[209] , \gpio_defaults[208] , \gpio_defaults[207] , \gpio_defaults[206] , \gpio_defaults[205] , \gpio_defaults[204] , \gpio_defaults[203] , \gpio_defaults[202] , \gpio_defaults[201] , \gpio_defaults[200]  }),
    .mgmt_gpio_in(\mgmt_io_in[20] ),
    .mgmt_gpio_oeb(\zero_loop2[1] ),
    .mgmt_gpio_out(\mgmt_io_out[20] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[41] , \mprj_io_drive_sel[40]  }),
    .pad_gpio_in(\mprj_io_in[20] ),
    .pad_gpio_inen(\mprj_io_ie[20] ),
    .pad_gpio_out(\mprj_io_out[20] ),
    .pad_gpio_outen(\mprj_io_oe[20] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[20] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[20] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[20] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[20] ),
  ...
  gpio_control_block \gpio_control_in_2[2]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[219] , \gpio_defaults[218] , \gpio_defaults[217] , \gpio_defaults[216] , \gpio_defaults[215] , \gpio_defaults[214] , \gpio_defaults[213] , \gpio_defaults[212] , \gpio_defaults[211] , \gpio_defaults[210]  }),
    .mgmt_gpio_in(\mgmt_io_in[21] ),
    .mgmt_gpio_oeb(\zero_loop2[2] ),
    .mgmt_gpio_out(\mgmt_io_out[21] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[43] , \mprj_io_drive_sel[42]  }),
    .pad_gpio_in(\mprj_io_in[21] ),
    .pad_gpio_inen(\mprj_io_ie[21] ),
    .pad_gpio_out(\mprj_io_out[21] ),
    .pad_gpio_outen(\mprj_io_oe[21] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[21] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[21] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[21] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[21] ),
  ...
  gpio_control_block \gpio_control_in_2[3]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[229] , \gpio_defaults[228] , \gpio_defaults[227] , \gpio_defaults[226] , \gpio_defaults[225] , \gpio_defaults[224] , \gpio_defaults[223] , \gpio_defaults[222] , \gpio_defaults[221] , \gpio_defaults[220]  }),
    .mgmt_gpio_in(\mgmt_io_in[22] ),
    .mgmt_gpio_oeb(\zero_loop2[3] ),
    .mgmt_gpio_out(\mgmt_io_out[22] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[45] , \mprj_io_drive_sel[44]  }),
    .pad_gpio_in(\mprj_io_in[22] ),
    .pad_gpio_inen(\mprj_io_ie[22] ),
    .pad_gpio_out(\mprj_io_out[22] ),
    .pad_gpio_outen(\mprj_io_oe[22] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[22] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[22] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[22] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[22] ),
  ...
  gpio_control_block \gpio_control_in_2[4]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[239] , \gpio_defaults[238] , \gpio_defaults[237] , \gpio_defaults[236] , \gpio_defaults[235] , \gpio_defaults[234] , \gpio_defaults[233] , \gpio_defaults[232] , \gpio_defaults[231] , \gpio_defaults[230]  }),
    .mgmt_gpio_in(\mgmt_io_in[23] ),
    .mgmt_gpio_oeb(\zero_loop2[4] ),
    .mgmt_gpio_out(\mgmt_io_out[23] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[47] , \mprj_io_drive_sel[46]  }),
    .pad_gpio_in(\mprj_io_in[23] ),
    .pad_gpio_inen(\mprj_io_ie[23] ),
    .pad_gpio_out(\mprj_io_out[23] ),
    .pad_gpio_outen(\mprj_io_oe[23] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[23] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[23] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[23] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[23] ),
  ...
  gpio_control_block \gpio_control_in_2[5]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[249] , \gpio_defaults[248] , \gpio_defaults[247] , \gpio_defaults[246] , \gpio_defaults[245] , \gpio_defaults[244] , \gpio_defaults[243] , \gpio_defaults[242] , \gpio_defaults[241] , \gpio_defaults[240]  }),
    .mgmt_gpio_in(\mgmt_io_in[24] ),
    .mgmt_gpio_oeb(\zero_loop2[5] ),
    .mgmt_gpio_out(\mgmt_io_out[24] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[49] , \mprj_io_drive_sel[48]  }),
    .pad_gpio_in(\mprj_io_in[24] ),
    .pad_gpio_inen(\mprj_io_ie[24] ),
    .pad_gpio_out(\mprj_io_out[24] ),
    .pad_gpio_outen(\mprj_io_oe[24] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[24] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[24] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[24] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[24] ),
  ...
  gpio_control_block \gpio_control_in_2[6]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[259] , \gpio_defaults[258] , \gpio_defaults[257] , \gpio_defaults[256] , \gpio_defaults[255] , \gpio_defaults[254] , \gpio_defaults[253] , \gpio_defaults[252] , \gpio_defaults[251] , \gpio_defaults[250]  }),
    .mgmt_gpio_in(\mgmt_io_in[25] ),
    .mgmt_gpio_oeb(\zero_loop2[6] ),
    .mgmt_gpio_out(\mgmt_io_out[25] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[51] , \mprj_io_drive_sel[50]  }),
    .pad_gpio_in(\mprj_io_in[25] ),
    .pad_gpio_inen(\mprj_io_ie[25] ),
    .pad_gpio_out(\mprj_io_out[25] ),
    .pad_gpio_outen(\mprj_io_oe[25] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[25] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[25] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[25] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[25] ),
  ...
  gpio_control_block \gpio_control_in_2[7]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[269] , \gpio_defaults[268] , \gpio_defaults[267] , \gpio_defaults[266] , \gpio_defaults[265] , \gpio_defaults[264] , \gpio_defaults[263] , \gpio_defaults[262] , \gpio_defaults[261] , \gpio_defaults[260]  }),
    .mgmt_gpio_in(\mgmt_io_in[26] ),
    .mgmt_gpio_oeb(\zero_loop2[7] ),
    .mgmt_gpio_out(\mgmt_io_out[26] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[53] , \mprj_io_drive_sel[52]  }),
    .pad_gpio_in(\mprj_io_in[26] ),
    .pad_gpio_inen(\mprj_io_ie[26] ),
    .pad_gpio_out(\mprj_io_out[26] ),
    .pad_gpio_outen(\mprj_io_oe[26] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[26] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[26] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[26] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[26] ),
  ...
  gpio_control_block \gpio_control_in_2[8]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[279] , \gpio_defaults[278] , \gpio_defaults[277] , \gpio_defaults[276] , \gpio_defaults[275] , \gpio_defaults[274] , \gpio_defaults[273] , \gpio_defaults[272] , \gpio_defaults[271] , \gpio_defaults[270]  }),
    .mgmt_gpio_in(\mgmt_io_in[27] ),
    .mgmt_gpio_oeb(\zero_loop2[8] ),
    .mgmt_gpio_out(\mgmt_io_out[27] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[55] , \mprj_io_drive_sel[54]  }),
    .pad_gpio_in(\mprj_io_in[27] ),
    .pad_gpio_inen(\mprj_io_ie[27] ),
    .pad_gpio_out(\mprj_io_out[27] ),
    .pad_gpio_outen(\mprj_io_oe[27] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[27] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[27] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[27] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[27] ),
  ...
  gpio_control_block \gpio_control_in_2[9]  (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[289] , \gpio_defaults[288] , \gpio_defaults[287] , \gpio_defaults[286] , \gpio_defaults[285] , \gpio_defaults[284] , \gpio_defaults[283] , \gpio_defaults[282] , \gpio_defaults[281] , \gpio_defaults[280]  }),
    .mgmt_gpio_in(\mgmt_io_in[28] ),
    .mgmt_gpio_oeb(\zero_loop2[9] ),
    .mgmt_gpio_out(\mgmt_io_out[28] ),
    .pad_gpio_drive_sel({ \mprj_io_drive_sel[57] , \mprj_io_drive_sel[56]  }),
    .pad_gpio_in(\mprj_io_in[28] ),
    .pad_gpio_inen(\mprj_io_ie[28] ),
    .pad_gpio_out(\mprj_io_out[28] ),
    .pad_gpio_outen(\mprj_io_oe[28] ),
    .pad_gpio_pulldown_sel(\mprj_io_pulldown_sel[28] ),
    .pad_gpio_pullup_sel(\mprj_io_pullup_sel[28] ),
    .pad_gpio_schmitt_sel(\mprj_io_schmitt_sel[28] ),
    .pad_gpio_slew_sel(\mprj_io_slew_sel[28] ),
  ...
  gpio_defaults_block_007 gpio_defaults_block_10 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[109] , \gpio_defaults[108] , \gpio_defaults[107] , \gpio_defaults[106] , \gpio_defaults[105] , \gpio_defaults[104] , \gpio_defaults[103] , \gpio_defaults[102] , \gpio_defaults[101] , \gpio_defaults[100]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_11 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[119] , \gpio_defaults[118] , \gpio_defaults[117] , \gpio_defaults[116] , \gpio_defaults[115] , \gpio_defaults[114] , \gpio_defaults[113] , \gpio_defaults[112] , \gpio_defaults[111] , \gpio_defaults[110]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_12 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[129] , \gpio_defaults[128] , \gpio_defaults[127] , \gpio_defaults[126] , \gpio_defaults[125] , \gpio_defaults[124] , \gpio_defaults[123] , \gpio_defaults[122] , \gpio_defaults[121] , \gpio_defaults[120]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_13 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[139] , \gpio_defaults[138] , \gpio_defaults[137] , \gpio_defaults[136] , \gpio_defaults[135] , \gpio_defaults[134] , \gpio_defaults[133] , \gpio_defaults[132] , \gpio_defaults[131] , \gpio_defaults[130]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_14 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[149] , \gpio_defaults[148] , \gpio_defaults[147] , \gpio_defaults[146] , \gpio_defaults[145] , \gpio_defaults[144] , \gpio_defaults[143] , \gpio_defaults[142] , \gpio_defaults[141] , \gpio_defaults[140]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_15 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[159] , \gpio_defaults[158] , \gpio_defaults[157] , \gpio_defaults[156] , \gpio_defaults[155] , \gpio_defaults[154] , \gpio_defaults[153] , \gpio_defaults[152] , \gpio_defaults[151] , \gpio_defaults[150]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_16 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[169] , \gpio_defaults[168] , \gpio_defaults[167] , \gpio_defaults[166] , \gpio_defaults[165] , \gpio_defaults[164] , \gpio_defaults[163] , \gpio_defaults[162] , \gpio_defaults[161] , \gpio_defaults[160]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_17 (
    .gpio_defaults({ \gpio_defaults[179] , \gpio_defaults[178] , \gpio_defaults[177] , \gpio_defaults[176] , \gpio_defaults[175] , \gpio_defaults[174] , \gpio_defaults[173] , \gpio_defaults[172] , \gpio_defaults[171] , \gpio_defaults[170]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_18 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[189] , \gpio_defaults[188] , \gpio_defaults[187] , \gpio_defaults[186] , \gpio_defaults[185] , \gpio_defaults[184] , \gpio_defaults[183] , \gpio_defaults[182] , \gpio_defaults[181] , \gpio_defaults[180]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_19 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[199] , \gpio_defaults[198] , \gpio_defaults[197] , \gpio_defaults[196] , \gpio_defaults[195] , \gpio_defaults[194] , \gpio_defaults[193] , \gpio_defaults[192] , \gpio_defaults[191] , \gpio_defaults[190]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_20 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[209] , \gpio_defaults[208] , \gpio_defaults[207] , \gpio_defaults[206] , \gpio_defaults[205] , \gpio_defaults[204] , \gpio_defaults[203] , \gpio_defaults[202] , \gpio_defaults[201] , \gpio_defaults[200]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_21 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[219] , \gpio_defaults[218] , \gpio_defaults[217] , \gpio_defaults[216] , \gpio_defaults[215] , \gpio_defaults[214] , \gpio_defaults[213] , \gpio_defaults[212] , \gpio_defaults[211] , \gpio_defaults[210]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_22 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[229] , \gpio_defaults[228] , \gpio_defaults[227] , \gpio_defaults[226] , \gpio_defaults[225] , \gpio_defaults[224] , \gpio_defaults[223] , \gpio_defaults[222] , \gpio_defaults[221] , \gpio_defaults[220]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_23 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[239] , \gpio_defaults[238] , \gpio_defaults[237] , \gpio_defaults[236] , \gpio_defaults[235] , \gpio_defaults[234] , \gpio_defaults[233] , \gpio_defaults[232] , \gpio_defaults[231] , \gpio_defaults[230]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_24 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[249] , \gpio_defaults[248] , \gpio_defaults[247] , \gpio_defaults[246] , \gpio_defaults[245] , \gpio_defaults[244] , \gpio_defaults[243] , \gpio_defaults[242] , \gpio_defaults[241] , \gpio_defaults[240]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_25 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[259] , \gpio_defaults[258] , \gpio_defaults[257] , \gpio_defaults[256] , \gpio_defaults[255] , \gpio_defaults[254] , \gpio_defaults[253] , \gpio_defaults[252] , \gpio_defaults[251] , \gpio_defaults[250]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_26 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[269] , \gpio_defaults[268] , \gpio_defaults[267] , \gpio_defaults[266] , \gpio_defaults[265] , \gpio_defaults[264] , \gpio_defaults[263] , \gpio_defaults[262] , \gpio_defaults[261] , \gpio_defaults[260]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_27 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[279] , \gpio_defaults[278] , \gpio_defaults[277] , \gpio_defaults[276] , \gpio_defaults[275] , \gpio_defaults[274] , \gpio_defaults[273] , \gpio_defaults[272] , \gpio_defaults[271] , \gpio_defaults[270]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_28 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[289] , \gpio_defaults[288] , \gpio_defaults[287] , \gpio_defaults[286] , \gpio_defaults[285] , \gpio_defaults[284] , \gpio_defaults[283] , \gpio_defaults[282] , \gpio_defaults[281] , \gpio_defaults[280]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_29 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[299] , \gpio_defaults[298] , \gpio_defaults[297] , \gpio_defaults[296] , \gpio_defaults[295] , \gpio_defaults[294] , \gpio_defaults[293] , \gpio_defaults[292] , \gpio_defaults[291] , \gpio_defaults[290]  })
  );
  ...
  gpio_defaults_block_007 gpio_defaults_block_30 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[309] , \gpio_defaults[308] , \gpio_defaults[307] , \gpio_defaults[306] , \gpio_defaults[305] , \gpio_defaults[304] , \gpio_defaults[303] , \gpio_defaults[302] , \gpio_defaults[301] , \gpio_defaults[300]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_31 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[319] , \gpio_defaults[318] , \gpio_defaults[317] , \gpio_defaults[316] , \gpio_defaults[315] , \gpio_defaults[314] , \gpio_defaults[313] , \gpio_defaults[312] , \gpio_defaults[311] , \gpio_defaults[310]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_32 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[329] , \gpio_defaults[328] , \gpio_defaults[327] , \gpio_defaults[326] , \gpio_defaults[325] , \gpio_defaults[324] , \gpio_defaults[323] , \gpio_defaults[322] , \gpio_defaults[321] , \gpio_defaults[320]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_33 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[339] , \gpio_defaults[338] , \gpio_defaults[337] , \gpio_defaults[336] , \gpio_defaults[335] , \gpio_defaults[334] , \gpio_defaults[333] , \gpio_defaults[332] , \gpio_defaults[331] , \gpio_defaults[330]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_34 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[349] , \gpio_defaults[348] , \gpio_defaults[347] , \gpio_defaults[346] , \gpio_defaults[345] , \gpio_defaults[344] , \gpio_defaults[343] , \gpio_defaults[342] , \gpio_defaults[341] , \gpio_defaults[340]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_35 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[359] , \gpio_defaults[358] , \gpio_defaults[357] , \gpio_defaults[356] , \gpio_defaults[355] , \gpio_defaults[354] , \gpio_defaults[353] , \gpio_defaults[352] , \gpio_defaults[351] , \gpio_defaults[350]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_36 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[369] , \gpio_defaults[368] , \gpio_defaults[367] , \gpio_defaults[366] , \gpio_defaults[365] , \gpio_defaults[364] , \gpio_defaults[363] , \gpio_defaults[362] , \gpio_defaults[361] , \gpio_defaults[360]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_37 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[379] , \gpio_defaults[378] , \gpio_defaults[377] , \gpio_defaults[376] , \gpio_defaults[375] , \gpio_defaults[374] , \gpio_defaults[373] , \gpio_defaults[372] , \gpio_defaults[371] , \gpio_defaults[370]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_5 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[59] , \gpio_defaults[58] , \gpio_defaults[57] , \gpio_defaults[56] , \gpio_defaults[55] , \gpio_defaults[54] , \gpio_defaults[53] , \gpio_defaults[52] , \gpio_defaults[51] , \gpio_defaults[50]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_6 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[69] , \gpio_defaults[68] , \gpio_defaults[67] , \gpio_defaults[66] , \gpio_defaults[65] , \gpio_defaults[64] , \gpio_defaults[63] , \gpio_defaults[62] , \gpio_defaults[61] , \gpio_defaults[60]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_7 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[79] , \gpio_defaults[78] , \gpio_defaults[77] , \gpio_defaults[76] , \gpio_defaults[75] , \gpio_defaults[74] , \gpio_defaults[73] , \gpio_defaults[72] , \gpio_defaults[71] , \gpio_defaults[70]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_8 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[89] , \gpio_defaults[88] , \gpio_defaults[87] , \gpio_defaults[86] , \gpio_defaults[85] , \gpio_defaults[84] , \gpio_defaults[83] , \gpio_defaults[82] , \gpio_defaults[81] , \gpio_defaults[80]  })
  );
  gpio_defaults_block_007 gpio_defaults_block_9 (
    .VDD(vdd),
    .VSS(vss),
    .gpio_defaults({ \gpio_defaults[99] , \gpio_defaults[98] , \gpio_defaults[97] , \gpio_defaults[96] , \gpio_defaults[95] , \gpio_defaults[94] , \gpio_defaults[93] , \gpio_defaults[92] , \gpio_defaults[91] , \gpio_defaults[90]  })
  );
  ...
  user_project_wrapper mprj (
    ...
    .la_data_in({ \la_data_in_user[63] , \la_data_in_user[62] , \la_data_in_user[61] , \la_data_in_user[60] , \la_data_in_user[59] , \la_data_in_user[58] , \la_data_in_user[57] , \la_data_in_user[56] , \la_data_in_user[55] , \la_data_in_user[54] , \la_data_in_user[53] , \la_data_in_user[52] , \la_data_in_user[51] , \la_data_in_user[50] , \la_data_in_user[49] , \la_data_in_user[48] , \la_data_in_user[47] , \la_data_in_user[46] , \la_data_in_user[45] , \la_data_in_user[44] , \la_data_in_user[43] , \la_data_in_user[42] , \la_data_in_user[41] , \la_data_in_user[40] , \la_data_in_user[39] , \la_data_in_user[38] , \la_data_in_user[37] , \la_data_in_user[36] , \la_data_in_user[35] , \la_data_in_user[34] , \la_data_in_user[33] , \la_data_in_user[32] , \la_data_in_user[31] , \la_data_in_user[30] , \la_data_in_user[29] , \la_data_in_user[28] , \la_data_in_user[27] , \la_data_in_user[26] , \la_data_in_user[25] , \la_data_in_user[24] , \la_data_in_user[23] , \la_data_in_user[22] , \la_data_in_user[21] , \la_data_in_user[20] , \la_data_in_user[19] , \la_data_in_user[18] , \la_data_in_user[17] , \la_data_in_user[16] , \la_data_in_user[15] , \la_data_in_user[14] , \la_data_in_user[13] , \la_data_in_user[12] , \la_data_in_user[11] , \la_data_in_user[10] , \la_data_in_user[9] , \la_data_in_user[8] , \la_data_in_user[7] , \la_data_in_user[6] , \la_data_in_user[5] , \la_data_in_user[4] , \la_data_in_user[3] , \la_data_in_user[2] , \la_data_in_user[1] , \la_data_in_user[0]  }),
    .la_data_out({ \la_data_out_user[63] , \la_data_out_user[62] , \la_data_out_user[61] , \la_data_out_user[60] , \la_data_out_user[59] , \la_data_out_user[58] , \la_data_out_user[57] , \la_data_out_user[56] , \la_data_out_user[55] , \la_data_out_user[54] , \la_data_out_user[53] , \la_data_out_user[52] , \la_data_out_user[51] , \la_data_out_user[50] , \la_data_out_user[49] , \la_data_out_user[48] , \la_data_out_user[47] , \la_data_out_user[46] , \la_data_out_user[45] , \la_data_out_user[44] , \la_data_out_user[43] , \la_data_out_user[42] , \la_data_out_user[41] , \la_data_out_user[40] , \la_data_out_user[39] , \la_data_out_user[38] , \la_data_out_user[37] , \la_data_out_user[36] , \la_data_out_user[35] , \la_data_out_user[34] , \la_data_out_user[33] , \la_data_out_user[32] , \la_data_out_user[31] , \la_data_out_user[30] , \la_data_out_user[29] , \la_data_out_user[28] , \la_data_out_user[27] , \la_data_out_user[26] , \la_data_out_user[25] , \la_data_out_user[24] , \la_data_out_user[23] , \la_data_out_user[22] , \la_data_out_user[21] , \la_data_out_user[20] , \la_data_out_user[19] , \la_data_out_user[18] , \la_data_out_user[17] , \la_data_out_user[16] , \la_data_out_user[15] , \la_data_out_user[14] , \la_data_out_user[13] , \la_data_out_user[12] , \la_data_out_user[11] , \la_data_out_user[10] , \la_data_out_user[9] , \la_data_out_user[8] , \la_data_out_user[7] , \la_data_out_user[6] , \la_data_out_user[5] , \la_data_out_user[4] , \la_data_out_user[3] , \la_data_out_user[2] , \la_data_out_user[1] , \la_data_out_user[0]  }),
    .la_oenb({ \la_oenb_user[63] , \la_oenb_user[62] , \la_oenb_user[61] , \la_oenb_user[60] , \la_oenb_user[59] , \la_oenb_user[58] , \la_oenb_user[57] , \la_oenb_user[56] , \la_oenb_user[55] , \la_oenb_user[54] , \la_oenb_user[53] , \la_oenb_user[52] , \la_oenb_user[51] , \la_oenb_user[50] , \la_oenb_user[49] , \la_oenb_user[48] , \la_oenb_user[47] , \la_oenb_user[46] , \la_oenb_user[45] , \la_oenb_user[44] , \la_oenb_user[43] , \la_oenb_user[42] , \la_oenb_user[41] , \la_oenb_user[40] , \la_oenb_user[39] , \la_oenb_user[38] , \la_oenb_user[37] , \la_oenb_user[36] , \la_oenb_user[35] , \la_oenb_user[34] , \la_oenb_user[33] , \la_oenb_user[32] , \la_oenb_user[31] , \la_oenb_user[30] , \la_oenb_user[29] , \la_oenb_user[28] , \la_oenb_user[27] , \la_oenb_user[26] , \la_oenb_user[25] , \la_oenb_user[24] , \la_oenb_user[23] , \la_oenb_user[22] , \la_oenb_user[21] , \la_oenb_user[20] , \la_oenb_user[19] , \la_oenb_user[18] , \la_oenb_user[17] , \la_oenb_user[16] , \la_oenb_user[15] , \la_oenb_user[14] , \la_oenb_user[13] , \la_oenb_user[12] , \la_oenb_user[11] , \la_oenb_user[10] , \la_oenb_user[9] , \la_oenb_user[8] , \la_oenb_user[7] , \la_oenb_user[6] , \la_oenb_user[5] , \la_oenb_user[4] , \la_oenb_user[3] , \la_oenb_user[2] , \la_oenb_user[1] , \la_oenb_user[0]  }),
    .user_clock2(mprj_clock2),
  ...
  mgmt_core_wrapper soc (
    ...
    .la_iena({ \la_iena_mprj[63] , \la_iena_mprj[62] , \la_iena_mprj[61] , \la_iena_mprj[60] , \la_iena_mprj[59] , \la_iena_mprj[58] , \la_iena_mprj[57] , \la_iena_mprj[56] , \la_iena_mprj[55] , \la_iena_mprj[54] , \la_iena_mprj[53] , \la_iena_mprj[52] , \la_iena_mprj[51] , \la_iena_mprj[50] , \la_iena_mprj[49] , \la_iena_mprj[48] , \la_iena_mprj[47] , \la_iena_mprj[46] , \la_iena_mprj[45] , \la_iena_mprj[44] , \la_iena_mprj[43] , \la_iena_mprj[42] , \la_iena_mprj[41] , \la_iena_mprj[40] , \la_iena_mprj[39] , \la_iena_mprj[38] , \la_iena_mprj[37] , \la_iena_mprj[36] , \la_iena_mprj[35] , \la_iena_mprj[34] , \la_iena_mprj[33] , \la_iena_mprj[32] , \la_iena_mprj[31] , \la_iena_mprj[30] , \la_iena_mprj[29] , \la_iena_mprj[28] , \la_iena_mprj[27] , \la_iena_mprj[26] , \la_iena_mprj[25] , \la_iena_mprj[24] , \la_iena_mprj[23] , \la_iena_mprj[22] , \la_iena_mprj[21] , \la_iena_mprj[20] , \la_iena_mprj[19] , \la_iena_mprj[18] , \la_iena_mprj[17] , \la_iena_mprj[16] , \la_iena_mprj[15] , \la_iena_mprj[14] , \la_iena_mprj[13] , \la_iena_mprj[12] , \la_iena_mprj[11] , \la_iena_mprj[10] , \la_iena_mprj[9] , \la_iena_mprj[8] , \la_iena_mprj[7] , \la_iena_mprj[6] , \la_iena_mprj[5] , \la_iena_mprj[4] , \la_iena_mprj[3] , \la_iena_mprj[2] , \la_iena_mprj[1] , \la_iena_mprj[0]  }),
    .la_input({ \la_data_in_mprj[63] , \la_data_in_mprj[62] , \la_data_in_mprj[61] , \la_data_in_mprj[60] , \la_data_in_mprj[59] , \la_data_in_mprj[58] , \la_data_in_mprj[57] , \la_data_in_mprj[56] , \la_data_in_mprj[55] , \la_data_in_mprj[54] , \la_data_in_mprj[53] , \la_data_in_mprj[52] , \la_data_in_mprj[51] , \la_data_in_mprj[50] , \la_data_in_mprj[49] , \la_data_in_mprj[48] , \la_data_in_mprj[47] , \la_data_in_mprj[46] , \la_data_in_mprj[45] , \la_data_in_mprj[44] , \la_data_in_mprj[43] , \la_data_in_mprj[42] , \la_data_in_mprj[41] , \la_data_in_mprj[40] , \la_data_in_mprj[39] , \la_data_in_mprj[38] , \la_data_in_mprj[37] , \la_data_in_mprj[36] , \la_data_in_mprj[35] , \la_data_in_mprj[34] , \la_data_in_mprj[33] , \la_data_in_mprj[32] , \la_data_in_mprj[31] , \la_data_in_mprj[30] , \la_data_in_mprj[29] , \la_data_in_mprj[28] , \la_data_in_mprj[27] , \la_data_in_mprj[26] , \la_data_in_mprj[25] , \la_data_in_mprj[24] , \la_data_in_mprj[23] , \la_data_in_mprj[22] , \la_data_in_mprj[21] , \la_data_in_mprj[20] , \la_data_in_mprj[19] , \la_data_in_mprj[18] , \la_data_in_mprj[17] , \la_data_in_mprj[16] , \la_data_in_mprj[15] , \la_data_in_mprj[14] , \la_data_in_mprj[13] , \la_data_in_mprj[12] , \la_data_in_mprj[11] , \la_data_in_mprj[10] , \la_data_in_mprj[9] , \la_data_in_mprj[8] , \la_data_in_mprj[7] , \la_data_in_mprj[6] , \la_data_in_mprj[5] , \la_data_in_mprj[4] , \la_data_in_mprj[3] , \la_data_in_mprj[2] , \la_data_in_mprj[1] , \la_data_in_mprj[0]  }),
    .la_oenb({ \la_oenb_mprj[63] , \la_oenb_mprj[62] , \la_oenb_mprj[61] , \la_oenb_mprj[60] , \la_oenb_mprj[59] , \la_oenb_mprj[58] , \la_oenb_mprj[57] , \la_oenb_mprj[56] , \la_oenb_mprj[55] , \la_oenb_mprj[54] , \la_oenb_mprj[53] , \la_oenb_mprj[52] , \la_oenb_mprj[51] , \la_oenb_mprj[50] , \la_oenb_mprj[49] , \la_oenb_mprj[48] , \la_oenb_mprj[47] , \la_oenb_mprj[46] , \la_oenb_mprj[45] , \la_oenb_mprj[44] , \la_oenb_mprj[43] , \la_oenb_mprj[42] , \la_oenb_mprj[41] , \la_oenb_mprj[40] , \la_oenb_mprj[39] , \la_oenb_mprj[38] , \la_oenb_mprj[37] , \la_oenb_mprj[36] , \la_oenb_mprj[35] , \la_oenb_mprj[34] , \la_oenb_mprj[33] , \la_oenb_mprj[32] , \la_oenb_mprj[31] , \la_oenb_mprj[30] , \la_oenb_mprj[29] , \la_oenb_mprj[28] , \la_oenb_mprj[27] , \la_oenb_mprj[26] , \la_oenb_mprj[25] , \la_oenb_mprj[24] , \la_oenb_mprj[23] , \la_oenb_mprj[22] , \la_oenb_mprj[21] , \la_oenb_mprj[20] , \la_oenb_mprj[19] , \la_oenb_mprj[18] , \la_oenb_mprj[17] , \la_oenb_mprj[16] , \la_oenb_mprj[15] , \la_oenb_mprj[14] , \la_oenb_mprj[13] , \la_oenb_mprj[12] , \la_oenb_mprj[11] , \la_oenb_mprj[10] , \la_oenb_mprj[9] , \la_oenb_mprj[8] , \la_oenb_mprj[7] , \la_oenb_mprj[6] , \la_oenb_mprj[5] , \la_oenb_mprj[4] , \la_oenb_mprj[3] , \la_oenb_mprj[2] , \la_oenb_mprj[1] , \la_oenb_mprj[0]  }),
    .la_output({ \la_data_out_mprj[63] , \la_data_out_mprj[62] , \la_data_out_mprj[61] , \la_data_out_mprj[60] , \la_data_out_mprj[59] , \la_data_out_mprj[58] , \la_data_out_mprj[57] , \la_data_out_mprj[56] , \la_data_out_mprj[55] , \la_data_out_mprj[54] , \la_data_out_mprj[53] , \la_data_out_mprj[52] , \la_data_out_mprj[51] , \la_data_out_mprj[50] , \la_data_out_mprj[49] , \la_data_out_mprj[48] , \la_data_out_mprj[47] , \la_data_out_mprj[46] , \la_data_out_mprj[45] , \la_data_out_mprj[44] , \la_data_out_mprj[43] , \la_data_out_mprj[42] , \la_data_out_mprj[41] , \la_data_out_mprj[40] , \la_data_out_mprj[39] , \la_data_out_mprj[38] , \la_data_out_mprj[37] , \la_data_out_mprj[36] , \la_data_out_mprj[35] , \la_data_out_mprj[34] , \la_data_out_mprj[33] , \la_data_out_mprj[32] , \la_data_out_mprj[31] , \la_data_out_mprj[30] , \la_data_out_mprj[29] , \la_data_out_mprj[28] , \la_data_out_mprj[27] , \la_data_out_mprj[26] , \la_data_out_mprj[25] , \la_data_out_mprj[24] , \la_data_out_mprj[23] , \la_data_out_mprj[22] , \la_data_out_mprj[21] , \la_data_out_mprj[20] , \la_data_out_mprj[19] , \la_data_out_mprj[18] , \la_data_out_mprj[17] , \la_data_out_mprj[16] , \la_data_out_mprj[15] , \la_data_out_mprj[14] , \la_data_out_mprj[13] , \la_data_out_mprj[12] , \la_data_out_mprj[11] , \la_data_out_mprj[10] , \la_data_out_mprj[9] , \la_data_out_mprj[8] , \la_data_out_mprj[7] , \la_data_out_mprj[6] , \la_data_out_mprj[5] , \la_data_out_mprj[4] , \la_data_out_mprj[3] , \la_data_out_mprj[2] , \la_data_out_mprj[1] , \la_data_out_mprj[0]  }),
  ...
  spare_logic_block \spare_logic[1]  (
    ...
    .spare_xz({ \spare_xz_nc[61] , \spare_xz_nc[60] , \spare_xz_nc[59] , \spare_xz_nc[58] , \spare_xz_nc[57] , \spare_xz_nc[56] , \spare_xz_nc[55] , \spare_xz_nc[54] , \spare_xz_nc[53] , \spare_xz_nc[52] , \spare_xz_nc[51] , \spare_xz_nc[50] , \spare_xz_nc[49] , \spare_xz_nc[48] , \spare_xz_nc[47] , \spare_xz_nc[46] , \spare_xz_nc[45] , \spare_xz_nc[44] , \spare_xz_nc[43] , \spare_xz_nc[42] , \spare_xz_nc[41] , \spare_xz_nc[40] , \spare_xz_nc[39] , \spare_xz_nc[38] , \spare_xz_nc[37] , \spare_xz_nc[36] , \spare_xz_nc[35] , \spare_xz_nc[34] , \spare_xz_nc[33] , \spare_xz_nc[32] , \spare_xz_nc[31]  })
  );
  spare_logic_block \spare_logic[2]  (
    ...
    .spare_xz({ \spare_xz_nc[92] , \spare_xz_nc[91] , \spare_xz_nc[90] , \spare_xz_nc[89] , \spare_xz_nc[88] , \spare_xz_nc[87] , \spare_xz_nc[86] , \spare_xz_nc[85] , \spare_xz_nc[84] , \spare_xz_nc[83] , \spare_xz_nc[82] , \spare_xz_nc[81] , \spare_xz_nc[80] , \spare_xz_nc[79] , \spare_xz_nc[78] , \spare_xz_nc[77] , \spare_xz_nc[76] , \spare_xz_nc[75] , \spare_xz_nc[74] , \spare_xz_nc[73] , \spare_xz_nc[72] , \spare_xz_nc[71] , \spare_xz_nc[70] , \spare_xz_nc[69] , \spare_xz_nc[68] , \spare_xz_nc[67] , \spare_xz_nc[66] , \spare_xz_nc[65] , \spare_xz_nc[64] , \spare_xz_nc[63] , \spare_xz_nc[62]  })
  );
  spare_logic_block \spare_logic[3]  (
    ...
    .spare_xz({ \spare_xz_nc[123] , \spare_xz_nc[122] , \spare_xz_nc[121] , \spare_xz_nc[120] , \spare_xz_nc[119] , \spare_xz_nc[118] , \spare_xz_nc[117] , \spare_xz_nc[116] , \spare_xz_nc[115] , \spare_xz_nc[114] , \spare_xz_nc[113] , \spare_xz_nc[112] , \spare_xz_nc[111] , \spare_xz_nc[110] , \spare_xz_nc[109] , \spare_xz_nc[108] , \spare_xz_nc[107] , \spare_xz_nc[106] , \spare_xz_nc[105] , \spare_xz_nc[104] , \spare_xz_nc[103] , \spare_xz_nc[102] , \spare_xz_nc[101] , \spare_xz_nc[100] , \spare_xz_nc[99] , \spare_xz_nc[98] , \spare_xz_nc[97] , \spare_xz_nc[96] , \spare_xz_nc[95] , \spare_xz_nc[94] , \spare_xz_nc[93]  })
  );
