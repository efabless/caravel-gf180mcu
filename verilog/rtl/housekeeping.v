...
`endif
	...
	case (address)
	    ...
	    /* GPIO Configuration */
	    8'h1d : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[0][IO_CTRL_BITS-1:8]};
	    8'h1e : fdata = gpio_configure[0][7:0];
	    8'h1f : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[1][IO_CTRL_BITS-1:8]};
	    8'h20 : fdata = gpio_configure[1][7:0];
	    8'h21 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[2][IO_CTRL_BITS-1:8]};
	    8'h22 : fdata = gpio_configure[2][7:0];
	    8'h23 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[3][IO_CTRL_BITS-1:8]};
	    8'h24 : fdata = gpio_configure[3][7:0];
	    8'h25 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[4][IO_CTRL_BITS-1:8]};
	    8'h26 : fdata = gpio_configure[4][7:0];
	    8'h27 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[5][IO_CTRL_BITS-1:8]};
	    8'h28 : fdata = gpio_configure[5][7:0];
	    8'h29 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[6][IO_CTRL_BITS-1:8]};
	    8'h2a : fdata = gpio_configure[6][7:0];
	    8'h2b : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[7][IO_CTRL_BITS-1:8]};
	    8'h2c : fdata = gpio_configure[7][7:0];
	    8'h2d : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[8][IO_CTRL_BITS-1:8]};
	    8'h2e : fdata = gpio_configure[8][7:0];
	    8'h2f : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[9][IO_CTRL_BITS-1:8]};
	    8'h30 : fdata = gpio_configure[9][7:0];
	    8'h31 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[10][IO_CTRL_BITS-1:8]};
	    8'h32 : fdata = gpio_configure[10][7:0];
	    8'h33 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[11][IO_CTRL_BITS-1:8]};
	    8'h34 : fdata = gpio_configure[11][7:0];
	    8'h35 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[12][IO_CTRL_BITS-1:8]};
	    8'h36 : fdata = gpio_configure[12][7:0];
	    8'h37 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[13][IO_CTRL_BITS-1:8]};
	    8'h38 : fdata = gpio_configure[13][7:0];
	    8'h39 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[14][IO_CTRL_BITS-1:8]};
	    8'h3a : fdata = gpio_configure[14][7:0];
	    8'h3b : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[15][IO_CTRL_BITS-1:8]};
	    8'h3c : fdata = gpio_configure[15][7:0];
	    8'h3d : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[16][IO_CTRL_BITS-1:8]};
	    8'h3e : fdata = gpio_configure[16][7:0];
	    8'h3f : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[17][IO_CTRL_BITS-1:8]};
	    8'h40 : fdata = gpio_configure[17][7:0];
	    8'h41 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[18][IO_CTRL_BITS-1:8]};
	    8'h42 : fdata = gpio_configure[18][7:0];
	    8'h43 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[19][IO_CTRL_BITS-1:8]};
	    8'h44 : fdata = gpio_configure[19][7:0];
	    8'h45 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[20][IO_CTRL_BITS-1:8]};
	    8'h46 : fdata = gpio_configure[20][7:0];
	    8'h47 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[21][IO_CTRL_BITS-1:8]};
	    8'h48 : fdata = gpio_configure[21][7:0];
	    8'h49 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[22][IO_CTRL_BITS-1:8]};
	    8'h4a : fdata = gpio_configure[22][7:0];
	    8'h4b : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[23][IO_CTRL_BITS-1:8]};
	    8'h4c : fdata = gpio_configure[23][7:0];
	    8'h4d : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[24][IO_CTRL_BITS-1:8]};
	    8'h4e : fdata = gpio_configure[24][7:0];
	    8'h4f : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[25][IO_CTRL_BITS-1:8]};
	    8'h50 : fdata = gpio_configure[25][7:0];
	    8'h51 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[26][IO_CTRL_BITS-1:8]};
	    8'h52 : fdata = gpio_configure[26][7:0];
	    8'h53 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[27][IO_CTRL_BITS-1:8]};
	    8'h54 : fdata = gpio_configure[27][7:0];
	    8'h55 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[28][IO_CTRL_BITS-1:8]};
	    8'h56 : fdata = gpio_configure[28][7:0];
	    8'h57 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[29][IO_CTRL_BITS-1:8]};
	    8'h58 : fdata = gpio_configure[29][7:0];
	    8'h59 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[30][IO_CTRL_BITS-1:8]};
	    8'h5a : fdata = gpio_configure[30][7:0];
	    8'h5b : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[31][IO_CTRL_BITS-1:8]};
	    8'h5c : fdata = gpio_configure[31][7:0];
	    8'h5d : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[32][IO_CTRL_BITS-1:8]};
	    8'h5e : fdata = gpio_configure[32][7:0];
	    8'h5f : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[33][IO_CTRL_BITS-1:8]};
	    8'h60 : fdata = gpio_configure[33][7:0];
	    8'h61 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[34][IO_CTRL_BITS-1:8]};
	    8'h62 : fdata = gpio_configure[34][7:0];
	    8'h63 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[35][IO_CTRL_BITS-1:8]};
	    8'h64 : fdata = gpio_configure[35][7:0];
	    8'h65 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[36][IO_CTRL_BITS-1:8]};
	    8'h66 : fdata = gpio_configure[36][7:0];
	    8'h67 : fdata = {{(16-IO_CTRL_BITS){0}}, gpio_configure[37][IO_CTRL_BITS-1:8]};
