...
/*--------------------------------------------------------------*/
/* caravan, an analog project harness for the Google/GF		*/
/* GF180MCU fabrication process and open source PDK		*/
/*                                                          	*/
/* Copyright 2023 efabless, Inc.                            	*/
...
/* Updated 02/09/2023:  Revised for the Caravan analog design	*/
/*                                                          	*/
/*--------------------------------------------------------------*/    
...
module caravan (
    ...
    wire [`MPRJ_IO_PADS-12:0] mprj_io_ie;
    wire [`MPRJ_IO_PADS-12:0] mprj_io_oe;
    wire [`MPRJ_IO_PADS-12:0] mprj_io_schmitt_sel;
    wire [`MPRJ_IO_PADS-12:0] mprj_io_slew_sel;
    wire [`MPRJ_IO_PADS-12:0] mprj_io_pullup_sel;
    wire [`MPRJ_IO_PADS-12:0] mprj_io_pulldown_sel;
    wire [(`MPRJ_IO_PADS-11)*2-1:0] mprj_io_drive_sel;
    wire [`MPRJ_IO_PADS-12:0] mprj_io_in;
    wire [`MPRJ_IO_PADS-12:0] mprj_io_out;
...
`endif
	...
	/* NOTE:  No attempt to rip out the GPIO control blocks for the
	 * middle portion of the I/Os that have been replaced with
	 * analog pads.  The control logic gets synthesized but is
	 * unused.  This is the easier approach.
	 */
	.mprj_io_in(mprj_io_in[`MPRJ_IO_PADS-12:14], 11'b0, mprj_io_in[13:0]),
	.mprj_io_out(mprj_io_out[`MPRJ_IO_PADS-12:14], 11'bz, mprj_io_out[13:0]),
	.mprj_io_oe(mprj_io_oe[`MPRJ_IO_PADS-12:14], 11'bz, mprj_io_oe[13:0]),
	.mprj_io_ie(mprj_io_ie[`MPRJ_IO_PADS-12:14], 11'bz, mprj_io_ie[13:0]),
	.mprj_io_schmitt_sel(mprj_io_schmitt_sel[`MPRJ_IO_PADS-12:14], 11'bz, mprj_io_schmitt_sel[13:0]),
	.mprj_io_pullup_sel(mprj_io_pullup_sel[`MPRJ_IO_PADS-12:14], 11'bz, mprj_io_pullup_sel[13:0]),
	.mprj_io_pulldown_sel(mprj_io_pulldown_sel[`MPRJ_IO_PADS-12:14], 11'bz, mprj_io_pulldown_sel[13:0]),
	.mprj_io_slew_sel(mprj_io_slew_sel[`MPRJ_IO_PADS-12:14], 11'bz, mprj_io_slew_sel[13:0]),
	.mprj_io_drive_sel(mprj_io_drive_sel[(`MPRJ_IO_PADS-11)*2-1:28], 22'bz, mprj_io_drive_sel[27:0]),
